...
type Notification = {
  id: string;
  type: "event" | "announcement" | "request" | "system" | "security" | "maintenance";
  title: string;
  message: string;
  time: string;
  timestamp: Date;
...
const generateMockNotifications = (): Notification[] => [
  {
    ...
    message: "Quarterly meeting on Sept 20 at 7PM in the community hall. Please RSVP by Sept 18.",
    time: "2h ago",
  ...
  },
  {
    ...
    message: "Pool will be closed for maintenance from Sept 15-18. We apologize for any inconvenience.",
    time: "1d ago",
  ...
  },
  {
    ...
    message: "Unit 304 submitted a plumbing issue. Please review and schedule a visit.",
    time: "3d ago",
  ...
  },
  {
    ...
    message: "Unusual activity detected near the east gate at 11:23 PM. Security team is investigating.",
    time: "5h ago",
  ...
  },
  {
    ...
    message: "Scheduled maintenance for Building B elevator on Sept 22 from 9AM-12PM.",
    time: "2d ago",
        ...
        <View style={styles.cardContent}>
          <View style={styles.iconContainer}>
            <Ionicons
              ...
              color={iconColor}
            />
            {!item.read && <View style={[styles.badge, { backgroundColor: priorityColor }]} />}
          </View>
      ...
      <Animated.View style={{ opacity: fadeAnim, flex: 1 }}>
        ...
        <View style={styles.header}>
          <View style={styles.headerContent}>
            <Ionicons name="notifications-outline" size={28} color={themeColors.primary} />
            <View>
        ...
        <View style={[styles.filterContainer, { backgroundColor: themeColors.card }]}>
          <TouchableOpacity
            style={[
              ...
              { backgroundColor: filter === "all" ? themeColors.primary : "transparent" }
            ]}
          ...
          <TouchableOpacity
            style={[
              ...
              { backgroundColor: filter === "unread" ? themeColors.primary : "transparent" }
            ]}
          ...
          >
            ...
            {unreadCount > 0 && (
              <View style={[styles.unreadCountBadge, { backgroundColor: themeColors.primary }]}>
