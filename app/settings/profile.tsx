    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      {isSuperAdmin && (
        <View style={styles.manageSection}>
          <Text style={[styles.subtitle, { color: theme.text }]}>Manage User Roles</Text>
          {users.map((u) => (
            <View key={u.id} style={styles.userRow}>
              ...
              <Picker
                ...
                onValueChange={(itemValue: RoleKey) => updateUserRole(u.id, itemValue)}
              >
      ...
      <View style={styles.buttons}>
        <Button title="Switch to Arabic" onPress={switchToArabic} color={theme.tint} />
        <Button title="Switch to English" onPress={switchToEnglish} color={theme.tint} />
        <Button
          title="Logout"
          onPress={async () => {
            await logoutUser();
