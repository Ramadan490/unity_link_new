...
const colorMap: Record<string, keyof ReturnType<typeof useTheme>['theme']['colors']> = {
...
export function useThemeColor(
  ...
  console.warn(`Color "${colorName}" not found in theme mapping, using primary as fallback`);
  return theme.colors.primary;
}

// For backward compatibility with the old Colors object
export const Colors = {
  get light() {
