    ...
    <ScrollView style={[styles.editorCard, { backgroundColor: theme.card }]}>
      ...
      <View style={styles.fieldContainer}>
        ...
        <View style={styles.row}>
          <TouchableOpacity
            style={[
              ...
              { backgroundColor: theme.background, flex: 2 },
            ]}
          ...
          <TouchableOpacity
            style={[
              styles.dateTimeButton,
              { backgroundColor: theme.background, flex: 1, marginLeft: 8 },
            ]}
        ...
        <View style={styles.quickOptions}>
          <Text
            style={[styles.quickOptionsLabel, { color: theme.secondaryText }]}
          >
            Quick select:
          </Text>
      ...
      <View style={styles.fieldContainer}>
        ...
        >
          <Text
            style={[
              styles.pickerText,
              { color: category ? theme.text : theme.secondaryText },
            ]}
          >
              ...
              >
                <View style={styles.pickerHeader}>
                  <TouchableOpacity onPress={() => setShowDatePicker(false)}>
                    <Text
                      style={[styles.pickerButtonText, { color: theme.tint }]}
                    >
                      Cancel
                    </Text>
                  </TouchableOpacity>
